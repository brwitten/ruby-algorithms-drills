require "rspec"
# require "./recursive_merge_solution.rb"
# require "./iterative_merge_solution.rb"
require "./in_class.rb"
...
RSpec.describe "#merge_sort" do
	...
	it "sorts strings" do
		students = [ "Bryan","Sarah", "Ilter", "Jacquelyn", "Adam",
      "Herman", "Phillbert", "Justin", "Anna", "Nathan",
      "John", "Paul", "Jonathan", "Marcelo", "Eric",
      "Rene", "Ayush", "Joanne", "Arthur", "Andrea" ]

		fully_reversed = ["Sarah", "Rene", "Phillbert", "Paul",
       "Nathan", "Marcelo", "Justin", "Jonathan", "John",
        "Joanne", "Jacquelyn", "Ilter", "Herman", "Eric",
         "Bryan", "Ayush", "Arthur", "Anna", "Andrea", "Adam"]
